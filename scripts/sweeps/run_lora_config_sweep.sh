...
#     scripts/sweeps/run_lora_config_sweep.sh                 # every config, in priority order
#     scripts/sweeps/run_lora_config_sweep.sh all4-r8 ff-r8   # just these
#     MAX_HOURS=6 scripts/sweeps/run_lora_config_sweep.sh
#
