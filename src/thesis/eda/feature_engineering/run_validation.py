...
Run with ``python -m thesis.eda.feature_engineering.run_validation``.
"""

import polars as pl

from thesis.eda.cache import ensure_event_cache
from thesis.eda.feature_engineering.diagnostic_criteria import diagnose_aki
from thesis.eda.feature_engineering.driver import load_uo_data
from thesis.eda.feature_engineering.validation import (
    aki_ground_truth,
